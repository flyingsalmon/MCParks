...
st.markdown("[📘 Map UI Navigation Help](UI_Guide)", unsafe_allow_html=True) # NOTE: this cannot open in new tab (for that use the previous method).
...
# And to refer to it as a link with st.markdown, remove any prefix number (1_) and extension (.py) but keep the underscores as in original file name!
